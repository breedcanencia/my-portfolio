...
export default function Contact() {
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-slate-900 to-slate-900 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700 hover:border-blue-500/50 transition-all duration-500 hover:transform hover:scale-[1.02] hover:shadow-2xl group">
            ...
            <div>
              ...
              <div className="space-y-6">
                <a 
                  ...
                  className="group flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl border border-slate-600 hover:border-blue-500/50 hover:bg-blue-800/20 transition-all duration-300"
                >
            ...
            <div>
              ...
              <div className="space-y-4">
                <a 
                  ...
                  className="group flex items-center gap-4 p-4 bg-slate-700/50 rounded-xl border border-slate-600 hover:border-blue-500/50 hover:bg-blue-800/20 transition-all duration-300 hover:transform hover:translate-x-1"
                >
                  <div className="w-10 h-10 bg-blue-600/20 rounded-lg flex items-center justify-center group-hover:bg-blue-600/30 transition-colors">
